...
<%
	...
	String course = request.getParameter("course");
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/project1","root","sam2127");
			String q = "insert into admin(course,branch,rollno,name,fathername,gender) values(?,?,?,?,?,?)";
